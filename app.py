...
st.markdown(f"""
    <style>
        ...
        /* Target all possible divider class names */
        ...
        div.st-emotion-cache-zt5igj {{display: none !important;}}
        div.css-zt5igj {{display: none !important;}}
        div.st-emotion-cache-16txtl3 {{display: none !important;}}
        
        /* Target common spacing elements */
        .stVerticalBlock {{margin-top: 0 !important; margin-bottom: 0 !important;}}
        .stHorizontalBlock {{margin-top: 0 !important; margin-bottom: 0 !important;}}
        ...
        /* Custom container to eliminate spacing */
        .no-space-container {{
            margin: 0 !important;
            padding: 0 !important;
            display: block;
...
def vendor_dashboard(vendor_id):
    ...
    # Progress gauge with larger title - using a no-space container
    st.markdown('<div class="no-space-container">', unsafe_allow_html=True)
    st.markdown('<h1 class="gauge-title">Items Remaining</h1>', unsafe_allow_html=True)

    # Display gauge without any gap
